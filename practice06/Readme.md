...
### ** leader code **
![](https://github.com/Beakyewon/logic-design/blob/master/practice10/graph.PNG)leader code (ir_rx)가 high인 구간에서의 시간이 8999 (9ms), low인 구간이 임을 볼수있었음.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU2MTM3ODEzOSwtMTAwNjEzNjM4NywtMT
